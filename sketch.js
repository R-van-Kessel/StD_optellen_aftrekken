...
function generateQuestions() {
    ...
    let answers = [];
    for (let i = 0; i < 10; i++) {
        let operation = floor(random(2)); // Alleen 0 (optellen) en 1 (aftrekken)
        let num1, num2, answer, text;
        if (operation === 0) {
            // Optellen: getallen tussen 20 en 200
            num1 = floor(random(20, 201));
            num2 = floor(random(20, 201));
            answer = num1 + num2;
            text = num1 + " + " + num2;
        } else {
            // Aftrekken: getallen tussen 20 en 200
            num1 = floor(random(20, 201));
            num2 = floor(random(20, num1 + 1)); // num2 moet kleiner zijn dan num1
            answer = num1 - num2;
            text = num1 + " - " + num2;
        }
